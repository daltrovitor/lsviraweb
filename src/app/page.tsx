...
import DashboardHome from './dashboard/sections/home';
import DisparosSection from './dashboard/sections/disparos';
import MapsSection from './dashboard/sections/maps';
import GruposSection from './dashboard/sections/grupos';
import AutomacaoSection from './dashboard/sections/automacao';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <footer className="py-6 text-center text-[11px] text-slate-400 font-medium">
        © 2026 LS da ViraWeb • Todos os direitos reservados
      </footer>
    </div>
  );
}
